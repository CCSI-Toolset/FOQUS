...
class surrogateMethod(surrogate):
    ...
    def __init__(self, dat=None):
        ...
        self.options.add(
            ...
            hint="These points will be used for model building along with the NDATA points specified by the user. NSAMPLE must be a nonnegative integer.",
        )
        self.options.add(
            name="MAXSIM",
            section="Data Settings",
        ...
        self.options.add(
            ...
            section="Model Settings",
            default=True,
            desc="Logarithmic functions are considered as basis "
