...
\input{Chapt_frontmatter/ccsi_manual}
%
...
\renewcommand{\ccsidate}{March 2018} %release date
\renewcommand{\ccsiversion}{2.2.0} %release version
...
\renewcommand{\ccsirevisiontablecontent}{
	...
	2.0.0 & 03/31/2018 & Initial Open Source Release \\ \hline
...
\begin{document}
	...
	\input{Chapt_intro/main.tex}
	\input{Chapt_flowsheet/main.tex}
	\input{Chapt_optimization/main.tex}
	\input{Chapt_uq/main.tex}
	\input{Chapt_solventfit/main.tex}
	\input{Chapt_ouu/main.tex}
	\input{Chapt_heat/main.tex}
	\input{Chapt_surrogates/main.tex}
	% \input{Chapt_drm/main.tex}
	\input{Chapt_sinter/main.tex}
	\input{Chapt_debug/main.tex}
	\makereferences{bib}
\end{document}
