...
9. The Sequential Design of Experiments (SDOE) module provides a smart way to coordinate future experiments or computer simulations. This method uses the error and/or uncertainty of the user's working model to determine the locations of the optimum points in the design (input) space for the next set of experiments or simulations.
