...
\begin{enumerate}
	...
	\item Enter \verb|["Error", "-ResultName"]| in the \bu{Sort Term} field.  This will sort the data first by \textbf{\underline{Error}} code then by \textbf{\underline{ResultName}} in reverse alphabetical order.
	\item Click \bu{Done}.
\end{enumerate}
