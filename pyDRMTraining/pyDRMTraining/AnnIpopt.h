...
#ifndef __ANNIPOPT_H__
#define __ANNIPOPT_H__
 ...
 *  CAnnIpopt implements a C++ example of problem 71 of the
 ...
 *
 */
class CAnnIpopt : public TNLP
{
public:
  int icount;
  CNeuralNetwork* pann;					//a pointer to artifitial neural network
  CDataCollection* pdc;					//a pointer to data collection of training data
  /** default constructor */
  CAnnIpopt();
...
private:
  ...
  //@{
  //  CAnnIpopt();
  CAnnIpopt(const CAnnIpopt&);
  CAnnIpopt& operator=(const CAnnIpopt&);
  //@}
};
