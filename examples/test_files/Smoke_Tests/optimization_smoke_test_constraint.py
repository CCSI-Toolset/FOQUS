...
try:  # Catch any exception and stop all timers before finishing up
    while 1:  # Loop and break and break as convenient way to jump to end
        ...
        MainWin.optSetupFrame.gTable.setItem(
            0, 0, QtWidgets.QTableWidgetItem("3-x['Rosenbrock']['x1']")
        )
        MainWin.optSetupFrame.gTable.setItem(0, 1, QtWidgets.QTableWidgetItem("10000"))
        MainWin.optSetupFrame.gAddButton.click()
        MainWin.optSetupFrame.gTable.setItem(
            1, 0, QtWidgets.QTableWidgetItem("8-x['Rosenbrock']['x6']")
        )
        MainWin.optSetupFrame.gTable.setItem(1, 1, QtWidgets.QTableWidgetItem("10000"))
        MainWin.optSetupFrame.gAddButton.click()
        MainWin.optSetupFrame.gTable.setItem(
            2, 0, QtWidgets.QTableWidgetItem("2-x['Rosenbrock']['x4']")
        )
