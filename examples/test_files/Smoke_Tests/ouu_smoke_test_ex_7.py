...
MAX_RUN_TIME = 1800000  # Maximum time to let script run in ms.
...
global errorTitle
global errorFile
errorFile = "AutoErrLog_ouu_ex_7.txt"
errorCount = 0
...
try:  # Catch any exception and stop all timers before finishing up
    while 1:  # Loop and break and break as convenient way to jump to end
        ...
        MainWin.dashFrame.setSessionDescription(
            "Optimization Under Uncertainty Description Text"
        )
        if not go():
            break
