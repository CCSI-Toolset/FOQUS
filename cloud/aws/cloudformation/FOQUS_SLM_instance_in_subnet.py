...
def _create_template(vpc_id, subnet_public_id, internetgateway_id,
    ...
    slm_instanceprofile = t.add_resource(iam.InstanceProfile(
        "SLMServerInstanceProfile",
...
def main():
    ...
    t = _create_template(vpc_id, subnet_public_id, internetgateway_id,
            network_interface_id, allocation_id)
    print(t.to_json())
