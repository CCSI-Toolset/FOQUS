...
_SinterVectorizeDialogUI, _SinterVectorizeDialog = \
        uic.loadUiType(os.path.join(mypath, "SinterVectorizeDialog_UI.ui"))
...
class SinterVectorizeDialog(_SinterVectorizeDialog, _SinterVectorizeDialogUI):
    ...
    def accept(self):
        ...
        sv.sintervectorize(json_file,input_vectors,output_vectors,vectorized_json_file)
