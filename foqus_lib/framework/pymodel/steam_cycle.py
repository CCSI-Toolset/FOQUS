...
class pymodel_pg(pymodel):
    ...
    def __init__(self):
        ...
        self.inputs["Net.Power"] = NodeVars(
            ...
            tags = [],
            dtype = float) #if dtype is not specified the type is taken
...
#        if self.inputs["FH.Heat.Addition"].value.any():
        ...
        decPowSt = 0.0047109*injHP + 0.0040667*injMP +\
                    0.11010*conHP + 0.085589*conMP
        # increase of net power output due to heat addition into
        # feed water heaters (MW)
        incPowFh = 0.013895*hrFH1 + 0.034086*hrFH2 +\
                    0.055540*hrFH3 + 0.073636*hrFH4 + 0.086699*hrFH5
        if NetPower > 0:
