...
========================================================
.. note::
    This tutorial utilizes SimSinter and Turbine, two optional software packages that integrate with FOQUS to run Aspen, Excel and gPROMS models. The installation instructions are located at :ref:`Install Turbine and SimSinter (Windows Only)<chapt_install/install_optional:Install Turbine and SimSinter (Windows Only)>`.
