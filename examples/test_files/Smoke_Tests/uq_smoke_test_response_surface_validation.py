...
"""
This test focuses on the response surface validation portion of the UQ
"""
...
global errorTitle
global errorFile
errorFile = "AutoErrLog_uq_response_surface_validation.txt"
errorCount = 0
...
def uq_analyze_scheme(MainWin=MainWin, getButton=getButton, timers=timers, go=go):
    ...
    if 'AnalysisDialog' in str(type(w)):
        ...
        errorTitle = "Choose Output to Analyze"
...
MainWin.close()
timerWait('msg_no')
print("Exited Code: UQ Response Surface Validation")
