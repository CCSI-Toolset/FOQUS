...
"""
This test focuses on the data visualization portion of the UQ
"""
...
global errorTitle
global errorFile
errorFile = "AutoErrLog_uq_data_visualization.txt"
errorCount = 0
...
MainWin.close()
timerWait('msg_no')
print("Exited Code: UQ Data Visualization")
